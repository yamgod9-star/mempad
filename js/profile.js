  ...
  init() {
    ...
    if (avatarInput) {
      avatarInput.addEventListener('change', (e) => {
        ...
        reader.onload = () => {
          ...
          Auth.updateUser({ avatarImage: dataUrl });
          Profile.render();
          if (avatarRemove) avatarRemove.style.display = 'block';
    ...
    if (avatarRemove) {
      avatarRemove.addEventListener('click', () => {
        Auth.updateUser({ avatarImage: null });
        Profile.render();
    ...
    if (bannerInput) {
      bannerInput.addEventListener('change', (e) => {
        ...
        reader.onload = () => {
          const dataUrl = reader.result;
          Auth.updateUser({ bannerImage: dataUrl });
          Profile.render();
          if (bannerRemove) bannerRemove.style.display = 'block';
    ...
    if (bannerRemove) {
      bannerRemove.addEventListener('click', () => {
        Auth.updateUser({ bannerImage: null });
        Profile.render();
