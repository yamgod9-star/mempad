...
const Profile = {
  ...
  render() {
    ...
    if (user.bannerImage) {
      ...
      const bannerHue = user.bannerHue !== undefined && user.bannerHue !== null ? user.bannerHue : 100;
      bannerOverlay.style.background = `linear-gradient(120deg, hsl(${bannerHue} 70% 20%), transparent 70%)`;
    }
